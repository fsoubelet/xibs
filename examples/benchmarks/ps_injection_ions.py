...
filepath = Path(__file__).parent.parent.parent / "tests" / "inputs" / "lines" / "ps_injection_ions.json"
harmonic_number = 16
geom_epsx = 1.990516908096345e-06
geom_epsy = 1.2440730675602156e-06
sig_delta = 3.833095415788846e-06
bunch_length_m = 0.06987309259463909
rf_voltage = 0.0380958  # in MV
...
ibs_step = 100  # frequency at which to re-compute the growth rates in [turns]
