...
assert np.isclose(MIBS.Ixx, IBS.ibs_growth_rates.Tx, rtol=1e-2)
assert np.isclose(MIBS.Iyy, IBS.ibs_growth_rates.Ty, rtol=1e-2)
assert np.isclose(MIBS.Ipp, IBS.ibs_growth_rates.Tz, rtol=1e-2)
