...
filepath = Path(__file__).parent.parent.parent / "tests" / "inputs" / "lines" / "ps_injection_protons.json"
harmonic_number = 16
geom_epsx = 2.685585552179665e-07
geom_epsy = 1.6784909701122905e-07
sig_delta = 0.0002740293584929326
bunch_length_m = 0.5684116447339836
rf_voltage = 0.200  # in MV
