...
def test_lhc_injection_protons(madx_lhc_injection_protons, xtrack_lhc_injection_protons):
    ...
    MIBS.Npart = beamparams.n_part  # also need to update this
    MIBS.calculate_integrals(Emit_x=params.geom_epsx, Emit_y=params.geom_epsy, Sig_M=params.sig_delta, BunchL=params.bunch_length)
    # --------------------------------------------------------------------
