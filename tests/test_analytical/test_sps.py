...
def test_sps_injection_protons(madx_sps_injection_protons, xtrack_sps_injection_protons):
    # --------------------------------------------------------------------
...
def test_sps_injection_ions(madx_sps_injection_ions, xtrack_sps_injection_ions):
    # --------------------------------------------------------------------
    # Get the growth rates from MAD-X
    ...
    # --------------------------------------------------------------------
    # Load equivalent xsuite line
    line = xtrack_sps_injection_ions
    twiss = line.twiss(method="4d")
    opticsparams = OpticsParameters(twiss)
    beamparams = BeamParameters(line.particle_ref)
    beamparams.n_part = madx.sequence.sps.beam.npart  # as line.particle_ref is only 1 particle
...
def test_sps_top_protons(madx_sps_top_protons, xtrack_sps_top_protons):
    # --------------------------------------------------------------------
    # Get the growth rates from MAD-X
...
def test_sps_top_ions(madx_sps_top_ions, xtrack_sps_top_ions):
    # --------------------------------------------------------------------
    # Get the growth rates from MAD-X
